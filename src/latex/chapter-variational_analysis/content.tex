...
Thus, if $y$ is an extremum, then one must have (cf. 
...
\index{Euler-Lagrange equation}{Equations!Euler-Lagrange}
...
The variables $p$ and $y$ are said to be \emph{canonical variables}\index{
canonical variables}\index{Variables!canonical}. When $y$ satisfies the 
...
In other words, the two previous conditions can be stated as
