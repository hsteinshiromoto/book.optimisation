...
\AtBeginSection[]{%
    ...
    \fill[gblue700]
        ([yshift=0pt]current page.west) rectangle ([yshift=-\headheight]
        current page.north east);
    \node[anchor=center]
        at ([yshift=50pt,xshift=0pt]current page.center) 
    ...
    \node[anchor=south]
        at ([yshift=50pt,xshift=0\linewidth]current page.south)
        {\parbox[t]{\textwidth}{
             \centering%
...
\setbeamercolor{subsection in toc}{fg=gblue700}
...
\setbeamertemplate{background canvas}{\tikz[overlay,remember picture]\node[opacity=0.5]at ([yshift=20pt,xshift=-30pt]current page.south east){\scalebox{0.15}{\input{imgs/qbe-logo.eps_tex}}};}
